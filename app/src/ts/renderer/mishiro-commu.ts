...
const template = require('../../res/banner.svg').default
...
class BannerRenderer {
  ...
  constructor (canvasid: string) {
    ...
    this.svg = createSVGElement(template)
  ...
  render (data: any) {
    ...
    setIcon('data:image/png;base64,' + iconB64)
    setEmblem('data:image/png;base64,' + emblemB64)
...
export default class extends Vue {
  ...
  query () {
    ...
    window.preload.client.getProfile(/* '646406677' */this.queryString).then(res => {
      ...
      this.renderer.render(createBannerData(res.data))
